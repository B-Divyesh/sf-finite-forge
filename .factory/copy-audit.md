...
Read-aloud result: “Build a beacon before sunset. Try it with sample data.”
The job and first action fit in one breath.

## Game board and outcomes

| Copy | Words | Result |
|---|---:|---|
| Every action spends one tick. | 5 | Pass |
